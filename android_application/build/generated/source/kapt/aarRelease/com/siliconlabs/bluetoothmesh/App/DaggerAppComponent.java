...
public final class DaggerAppComponent implements AppComponent {
  ...
  private Map<Class<?>, Provider<AndroidInjector.Factory<?>>>
    ...
    return MapBuilder.<Class<?>, Provider<AndroidInjector.Factory<?>>>newMapBuilder(11)
        ...
        .put(NetworkFragment.class, (Provider) networkFragmentSubcomponentBuilderProvider)
        .put(DeviceListFragment.class, (Provider) deviceListFragmentSubcomponentBuilderProvider)
        .put(GroupListFragment.class, (Provider) groupListFragmentSubcomponentBuilderProvider)
        .put(ScannerFragment.class, (Provider) scannerFragmentSubcomponentBuilderProvider)
        .put(NetworkListFragment.class, (Provider) networkListFragmentSubcomponentBuilderProvider)
        .put(DeviceDialogFragment.class, (Provider) deviceDialogFragmentSubcomponentBuilderProvider)
        .put(DeviceInfoFragment.class, (Provider) deviceInfoFragmentSubcomponentBuilderProvider)
        .put(DeviceConfigFragment.class, (Provider) deviceConfigFragmentSubcomponentBuilderProvider)
        .put(ControlGroupFragment.class, (Provider) controlGroupFragmentSubcomponentBuilderProvider)
        .build();
  }
  ...
  private static final class Builder implements AppComponent.Builder {
    ...
    public AppComponent build() {
      ...
      return new DaggerAppComponent(appModule, application);
    }
  }
  ...
  private final class MainActivitySubcomponentBuilder
    ...
    public ActivityBuilder_BindMainActivity.MainActivitySubcomponent build() {
      ...
      return new MainActivitySubcomponentImpl(mainActivityModule, seedInstance);
    }
  }
  ...
  private final class MainActivitySubcomponentImpl
    ...
    private MainActivitySubcomponentImpl(
        MainActivityModule mainActivityModuleParam, MainActivity seedInstanceParam) {
  ...
  private final class MainFragmentSubcomponentBuilder
    ...
    public ActivityBuilder_BindMainFragment.MainFragmentSubcomponent build() {
      ...
      Preconditions.checkBuilderRequirement(seedInstance, MainFragment.class);
      return new MainFragmentSubcomponentImpl(mainFragmentModule, seedInstance);
    }
  }

  private final class MainFragmentSubcomponentImpl
      implements ActivityBuilder_BindMainFragment.MainFragmentSubcomponent {
    private final MainFragment seedInstance;

    private final MainFragmentModule mainFragmentModule;

    private MainFragmentSubcomponentImpl(
        MainFragmentModule mainFragmentModuleParam, MainFragment seedInstanceParam) {
      this.seedInstance = seedInstanceParam;
  ...
  private final class NetworkFragmentSubcomponentBuilder
    ...
    public ActivityBuilder_BindNetworkFragment.NetworkFragmentSubcomponent build() {
      ...
      Preconditions.checkBuilderRequirement(seedInstance, NetworkFragment.class);
      return new NetworkFragmentSubcomponentImpl(networkModule, seedInstance);
    }
  }
  ...
  private final class NetworkFragmentSubcomponentImpl
    ...
    private final NetworkFragment seedInstance;

    private final NetworkModule networkModule;

    private NetworkFragmentSubcomponentImpl(
        NetworkModule networkModuleParam, NetworkFragment seedInstanceParam) {
      this.seedInstance = seedInstanceParam;
  ...
  private final class DeviceListFragmentSubcomponentBuilder
    ...
    public ActivityBuilder_BindDeviceListFragment.DeviceListFragmentSubcomponent build() {
      ...
      Preconditions.checkBuilderRequirement(seedInstance, DeviceListFragment.class);
      return new DeviceListFragmentSubcomponentImpl(deviceListModule, seedInstance);
    }
  }
  ...
  private final class DeviceListFragmentSubcomponentImpl
    ...
    private final DeviceListFragment seedInstance;

    private final DeviceListModule deviceListModule;

    private DeviceListFragmentSubcomponentImpl(
        DeviceListModule deviceListModuleParam, DeviceListFragment seedInstanceParam) {
      this.seedInstance = seedInstanceParam;
      this.deviceListModule = deviceListModuleParam;
    }
  ...
  private final class GroupListFragmentSubcomponentBuilder
    ...
    public ActivityBuilder_BindGroupListFragment.GroupListFragmentSubcomponent build() {
      ...
      Preconditions.checkBuilderRequirement(seedInstance, GroupListFragment.class);
      return new GroupListFragmentSubcomponentImpl(groupListModule, seedInstance);
    }
  }
  ...
  private final class GroupListFragmentSubcomponentImpl
    ...
    private final GroupListFragment seedInstance;

    private final GroupListModule groupListModule;

    private GroupListFragmentSubcomponentImpl(
        GroupListModule groupListModuleParam, GroupListFragment seedInstanceParam) {
      this.seedInstance = seedInstanceParam;
      this.groupListModule = groupListModuleParam;
    }
  ...
  private final class ScannerFragmentSubcomponentBuilder
    ...
    public ActivityBuilder_BindScannerFragment.ScannerFragmentSubcomponent build() {
      ...
      Preconditions.checkBuilderRequirement(seedInstance, ScannerFragment.class);
      return new ScannerFragmentSubcomponentImpl(scannerModule, seedInstance);
    }
  }
  ...
  private final class ScannerFragmentSubcomponentImpl
    ...
    private final ScannerFragment seedInstance;

    private final ScannerModule scannerModule;

    private ScannerFragmentSubcomponentImpl(
        ScannerModule scannerModuleParam, ScannerFragment seedInstanceParam) {
      this.seedInstance = seedInstanceParam;
  ...
  private final class NetworkListFragmentSubcomponentBuilder
    ...
    public ActivityBuilder_BindNetworkListFragment.NetworkListFragmentSubcomponent build() {
      ...
      Preconditions.checkBuilderRequirement(seedInstance, NetworkListFragment.class);
      return new NetworkListFragmentSubcomponentImpl(networkListModule, seedInstance);
    }
  }
  ...
  private final class NetworkListFragmentSubcomponentImpl
    ...
    private final NetworkListFragment seedInstance;

    private final NetworkListModule networkListModule;

    private NetworkListFragmentSubcomponentImpl(
        NetworkListModule networkListModuleParam, NetworkListFragment seedInstanceParam) {
      this.seedInstance = seedInstanceParam;
      this.networkListModule = networkListModuleParam;
    }
  ...
  private final class DeviceDialogFragmentSubcomponentBuilder
    ...
    public ActivityBuilder_BindDeviceDialogFragment.DeviceDialogFragmentSubcomponent build() {
      ...
      Preconditions.checkBuilderRequirement(seedInstance, DeviceDialogFragment.class);
      return new DeviceDialogFragmentSubcomponentImpl(deviceDialogModule, seedInstance);
    }
  }
  ...
  private final class DeviceDialogFragmentSubcomponentImpl
    ...
    private final DeviceDialogFragment seedInstance;

    private final DeviceDialogModule deviceDialogModule;

    private DeviceDialogFragmentSubcomponentImpl(
        DeviceDialogModule deviceDialogModuleParam, DeviceDialogFragment seedInstanceParam) {
      this.seedInstance = seedInstanceParam;
      this.deviceDialogModule = deviceDialogModuleParam;
    }
  ...
  private final class DeviceInfoFragmentSubcomponentBuilder
    ...
    public ActivityBuilder_BindDeviceInfoFragment.DeviceInfoFragmentSubcomponent build() {
      ...
      Preconditions.checkBuilderRequirement(seedInstance, DeviceInfoFragment.class);
      return new DeviceInfoFragmentSubcomponentImpl(deviceInfoModule, seedInstance);
    }
  }
  ...
  private final class DeviceInfoFragmentSubcomponentImpl
    ...
    private final DeviceInfoFragment seedInstance;

    private final DeviceInfoModule deviceInfoModule;

    private DeviceInfoFragmentSubcomponentImpl(
        DeviceInfoModule deviceInfoModuleParam, DeviceInfoFragment seedInstanceParam) {
      this.seedInstance = seedInstanceParam;
      this.deviceInfoModule = deviceInfoModuleParam;
    }
  ...
  private final class DeviceConfigFragmentSubcomponentBuilder
    ...
    public ActivityBuilder_BindDeviceConfigFragment.DeviceConfigFragmentSubcomponent build() {
      ...
      Preconditions.checkBuilderRequirement(seedInstance, DeviceConfigFragment.class);
      return new DeviceConfigFragmentSubcomponentImpl(deviceConfigModule, seedInstance);
    }
  }
  ...
  private final class DeviceConfigFragmentSubcomponentImpl
    ...
    private final DeviceConfigFragment seedInstance;

    private final DeviceConfigModule deviceConfigModule;

    private DeviceConfigFragmentSubcomponentImpl(
        DeviceConfigModule deviceConfigModuleParam, DeviceConfigFragment seedInstanceParam) {
      this.seedInstance = seedInstanceParam;
      this.deviceConfigModule = deviceConfigModuleParam;
    }
  ...
  private final class ControlGroupFragmentSubcomponentBuilder
    ...
    public ActivityBuilder_BindControlGroupFragment.ControlGroupFragmentSubcomponent build() {
      ...
      Preconditions.checkBuilderRequirement(seedInstance, ControlGroupFragment.class);
      return new ControlGroupFragmentSubcomponentImpl(controlGroupModule, seedInstance);
    }
  }
  ...
  private final class ControlGroupFragmentSubcomponentImpl
    ...
    private final ControlGroupFragment seedInstance;

    private final ControlGroupModule controlGroupModule;

    private ControlGroupFragmentSubcomponentImpl(
        ControlGroupModule controlGroupModuleParam, ControlGroupFragment seedInstanceParam) {
      this.seedInstance = seedInstanceParam;
      this.controlGroupModule = controlGroupModuleParam;
    }
